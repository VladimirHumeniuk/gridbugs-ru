...
1. [`grid-auto-rows` и `grid-auto-columns` должен принимать список направляющих.](#1)
2. [Повторная нотация должна заново принимать список направляющих.](#2)
3. [Поддержка фрагментации.](#3)
4. [Выравнивание элементов с собственными размерами в сетках с фиксированными направляющими.](#4)
5. [Элементы с внутренним соотношением сторон должны выравниваться в начале.](#5)
6. [`grid-gap` параметры должны принимать значение в процентах.](#6)
7. [Grid отступы должны вести себя как направляющие с авто-размерами?](#7)
8. [Установка максимальной высоты в процентах должна уменьшать изображение большего размера внутри направляющих сетки.](#8)
9. [`min-content` и `max-content` в направляющих.](#9)
10. [Некоторые HTML элементы не могут быть грид-контейнерами.](#10)
11. [Текстовое поле, которое является элементом сетки, сворачивается до нулевой ширины.](#11)
12. [Пространство, распространяемое на пустые направляющие, растягивается элементами с контентом.](#12)
13. [Несостыковки с процентными паддингами и марджинами.](#13)
14. [fit-content растягивается.](#14)

### <a name="1"></a>1. `grid-auto-rows` и `grid-auto-columns` должен принимать список направляющих.
